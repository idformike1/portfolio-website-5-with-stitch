...
export function CoachingCollaborations() {
  ...
  return (
    <section className="px-6 md:px-20 lg:px-40 py-24 mb-32 bg-white rounded-t-3xl shadow-2xl overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-24 items-center">
        <div className="w-full md:w-1/2">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-8xl md:text-[140px] font-bold mb-12 leading-[0.85] tracking-tighter text-[#333333] uppercase"
          >
