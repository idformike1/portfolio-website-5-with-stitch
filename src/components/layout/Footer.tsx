  ...
  return (
    <footer className="bg-[#6B705C] pt-24 pb-12 px-6 md:px-12 text-[#F0F0E8] relative mt-32">
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="text-[10px] font-bold opacity-60 uppercase tracking-widest">
              © Aisha All rights reserved
            </div>
          </div>
        </div>

        <div className="flex flex-col items-end gap-12">
          {/* Mobile Device Mockup in footer like reference */}
      ...
      <div className="relative mt-20">
        <div className="flex justify-between items-baseline border-t border-white/10 pt-12">
          <Button 
            onClick={scrollToTop}
            variant="outline"
            size="icon"
            className="w-12 h-12 rounded-full bg-[#F0F0E8] text-[#6B705C] border-none hover:scale-110 transition-transform active:scale-95"
          >
